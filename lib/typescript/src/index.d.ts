...
export declare const Tabs: {
    ...
    FlatList: <T>(p: import("react-native").FlatListProps<T> & {
        ref?: React.Ref<import("react-native").FlatList<T>>;
    }) => React.ReactElement;
    ...
    FlashList: <T>(p: import("@shopify/flash-list").FlashListProps<T> & {
        ref?: React.Ref<import("@shopify/flash-list").FlashList<T>>;
    }) => React.ReactElement;
    MasonryFlashList: <T>(p: import("@shopify/flash-list").MasonryFlashListProps<T> & {
        ref?: React.Ref<import("@shopify/flash-list").MasonryFlashListRef<any>>;
    }) => React.ReactElement;
    LegendList: <T>(p: import("@legendapp/list").LegendListProps<T> & {
        ref?: React.Ref<import("@legendapp/list").LegendListRef>;
    }) => React.ReactElement;
};
export { Container, Tab, Lazy, FlatList, ScrollView, SectionList, FlashList, MasonryFlashList, LegendList, };
